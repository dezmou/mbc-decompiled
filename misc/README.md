...
So it work, I recreated the contract and when I use panoramix to decompile it, it return the very exact pseudo code as the original contract (decompiled.py and test.py)
