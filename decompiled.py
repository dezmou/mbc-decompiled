...
def unknown8260dd31(uint256 _param1, uint32 _param2, uint32 _param3, uint256 _param4): # not payable
  ...
  while stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1].length + 320 > idx + 32:
      ...
      s = s + 1
      continue 
  log 0x6ea16f87: _param1, _param2 << 224, _param3 << 224, stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))].field_0, Array(len=stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1].length, data=mem3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1].length + (floor32(stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1].length - 1) + -stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1].length + 32 % 32)]), _param4

def unknownc6030f4d(): # not payable
  require uint32(cd) < 4
  require uint32(cd) < 4
  require stor[(3 * uint32(cd)) + (12 * uint32(cd)) + ('map', ('cd', 4), ('name', 'unknownc056b707', 3))].field_0 == caller
  require uint32(cd) < 4
  require uint32(cd) < 4
  stor[(3 * uint32(cd)) + (12 * uint32(cd)) + ('map', ('cd', 4), ('name', 'unknownc056b707', 3))].field_256 = (2 * ('cd', 100).length) + 1
  s = 0
  idx = cd[100] + 36
  while cd('cd', 100).length + 36 > idx:
      stor[s + sha3((3 * uint32(cd)) + (12 * uint32(cd)) + ('map', ('cd', 4), ('name', 'unknownc056b707', 3)) + 1)].field_0 = cd[idx]
      s = s + 1
      idx = idx + 32
      continue 
  idx = Mask(251, 0, ('cd', 100).length + 31) >> 5
  while stor[(3 * uint32(cd)) + (12 * uint32(cd)) + ('map', ('cd', 4), ('name', 'unknownc056b707', 3)) + 1].length + 31 / 32 > idx:
      stor[idx + sha3((3 * uint32(cd)) + (12 * uint32(cd)) + ('map', ('cd', 4), ('name', 'unknownc056b707', 3)) + 1)].field_0 = 0
      idx = idx + 1
      continue 
  require uint32(cd) < 4
  require uint32(cd) < 4
  require uint32(cd) < 4
  require uint32(cd) < 4
  log 0x6ea16f87: cdap', ('cd', 4), ('name', 'unknownc056b707', 3))].field_0, Array(len=('cd', 100).length, data=call.data[cdap', ('cd', 4), ('name', 'unknownc056b707', 3))].field_512
