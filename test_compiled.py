...
[95mdef [0munknown93ec714e(uint256 [32m_param1[0m, uint32 [32m_param2[0m, uint32 [32m_param3[0m, array [32m_param4[0m)[95m payable[0m: 
  require [32m_param2[0m[1m < [0m4
  require [32m_param3[0m[1m < [0m4
  if not [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_0[0m:
      require call.value[1m >= [0m[32mcost[0m
      [38;5;8mlog 0xe1500d0d: _param1, _param2 << 224, _param3 << 224, addr(this.address), caller, cost[0m
  else:
      require [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_0[0m != caller
      require [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_512[0m
      require call.value[1m >= [0m[32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_512[0m
      [38;5;8mlog 0xe1500d0d: _param1, _param2 << 224, _param3 << 224, stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))].field_0, caller, stor[(3 * _param3) + (12 * _param2) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))].field_512[0m
      call [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_0[0m with:
         value [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_512[0m[1m * [0m[32mpercent[0m[1m / [0m100 [38;5;8mwei[0m
           gas 2300 * is_zero(value) [38;5;8mwei[0m
      require ext_call.success
  require [32m_param2[0m[1m < [0m4
  require [32m_param3[0m[1m < [0m4
  [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_0[0m = caller
  [32mstor[[0msha3((3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3)) + 1)[32m][0m[32m[[0m[32m][0m[32m.field_0[0m = [38;5;8mArray(len=[0m[32m_param4.length[0m[38;5;8m, data=[0m[32m_param4[[0mall[32m][0m[38;5;8m)[0m
  [32mstor[[0m(3[1m * [0m[32m_param3[0m) + (12[1m * [0m[32m_param2[0m) + ('map', ('param', '_param1'), ('name', 'unknownc056b707', 3))[32m][0m[32m.field_512[0m = 0
